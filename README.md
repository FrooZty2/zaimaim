...
**Zaim_Aim - is a lightweight opensource CS:GO external cheat which supports lots of features.**

Run Zaim Aim exe for an easy set-up

## About
Zaim_Aim - is an external feature-rich hack.\
